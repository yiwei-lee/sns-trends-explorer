   ...
   public ChartGenerator(String chartTitle, String filePath) {
	   ...
	   switch (chartTitle){
	   		case "Probability Statistics of Topics":
	   	        ...
	   	        JFreeChart barChart = ChartFactory.createBarChart(chartTitle, "Topic", "documents", createDatasetForBasicBarChart(data),PlotOrientation.VERTICAL, true, true, false);
	   	        ...
	   	        try{
		   	        ChartUtilities.saveChartAsPNG(new File("./basicBarchart.png"), barChart, 1000, 540);
	   	        }catch(IOException e){
	   				e.printStackTrace();
	   			}
	   	        break;
